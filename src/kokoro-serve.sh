...
export AGENT_VOICE_KOKORO_VOICE="${AGENT_VOICE_KOKORO_VOICE:-zf_001}"
export AGENT_VOICE_CHUNK="${AGENT_VOICE_CHUNK:-clause}"
export AGENT_VOICE_PAUSE_SCALE="${AGENT_VOICE_PAUSE_SCALE:-1.0}"
export AGENT_VOICE_TARGET_RMS_DB="${AGENT_VOICE_TARGET_RMS_DB:--18}"
export AGENT_VOICE_SQUASH_GAPS="${AGENT_VOICE_SQUASH_GAPS:-1}"
